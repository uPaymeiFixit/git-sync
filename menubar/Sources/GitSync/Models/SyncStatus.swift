...
enum SyncStatus: String, Codable, CaseIterable, Sendable {
    ...
    var explanation: String {
        ...
        case .staleOnDisk:   return "You have this on disk, but the remote no longer lists it — deleted, renamed, or transferred on the server. Safe to delete locally once you've confirmed nothing in it is yours."
